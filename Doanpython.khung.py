...
class DanhSach(Generic[T]):
    def __init__(self):
        self.__DanhSach = []

    def Them(self, item):
        self.__DanhSach.append(item)

    def Xoa(self, item):
        if item in self.__DanhSach:
            self.__DanhSach.remove(item)

    def Dem(self):
        return len(self.__DanhSach)
...
#virtual
    def Xuat(self):
        pass
#virtual - python khong co tu khoa nay
    def Nhap(self):
        pass
#abstract
    @abstractmethod
...
#Property Gía
    ...
    def Gia(self,value):
        ...
        self._Gia=value
#Virtual - Python không cần có từ khóa này
    def Nhap(self):
        pass
#Virtual
    def HienThi(self):
...
#8.LỚP PHƯƠNG THỨC THANH TOÁN (LỚP CHA)
class PhuongThucThanhToan(ABC): 
#Abstract method
    @abstractmethod
    def XuLyThanhToan(self,soTien):
        pass
#9.LỚP TIỀN MẶT ( LỚP CON KẾ THỪA PHƯƠNG THỨC THANH TOÁN )
class TienMat(PhuongThucThanhToan):
#Override phuong thuc XulyThanhToan
    def XuLyThanhToan(self,soTien):
        pass

#10.LỚP VÍ ĐIỆN TỬ ( LỚP CON KẾ THỪA PHƯƠNG THỨC THANH TOÁN )
...
#11.LỚP THẺ ( LỚP CON KẾ THỪA PHƯƠNG THỨC THANH TOÁN )
...
# Static method
    @staticmethod
    def TinhPhiShipTheoKhoangCach(khoangCachKm):
        pass
#In Hóa Đơn:
    def InHoaDon(self):
        pass
...
class UngDung:
    def __init__(self):
        self.__DSKhachHang = DanhSach[KhachHang]()
        self.__DSChuQuan = DanhSach[ChuQuan]()
        self.__DSTaiXe = DanhSach[TaiXe]()
        self.__DSQuan = DanhSach[Quan]()
        self.__DSDonHang = DanhSach[DonHang]()
#Thêm khách hàng
